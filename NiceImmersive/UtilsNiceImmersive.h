...
class AUtilsNiceImmersive
{

public:
    template <typename T>
    static T* GetNicePlayerComponent(AActor* PlayerPawn)
    {
    ...
    bool static AreEnemies(AController* Controller1, AController* Controller2)
    {
        ...
        const auto PlayerState1 = Cast<ANicePlayerState>(Controller1->PlayerState);
        const auto PlayerState2 = Cast<ANicePlayerState>(Controller2->PlayerState);
